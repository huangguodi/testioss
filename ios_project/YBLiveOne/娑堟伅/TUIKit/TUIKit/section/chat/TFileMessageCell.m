...
- (void)downloadFile:(TDownloadProgress)progress response:(TDownloadResponse)response
{
    ...
    if(isExist){
        ...
        //网络下载
        V2TIMFileElem *imFile = [self getIMFileElem];
        _isDownloading = YES;
        ...
        [imFile downloadFile:path progress:^(NSInteger curSize, NSInteger totalSize) {
            dispatch_async(dispatch_get_main_queue(), ^{
...
//            V2TIMFileElem *imFileElem = (V2TIMFileElem *)imElem;
//            return imFileElem;
//        }
//    }
//    return nil;
    V2TIMMessage *imMsg = self.custom;
    V2TIMFileElem *fileElem = imMsg.fileElem;
    return fileElem;
}
@end
