...
@interface TMenuView () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
@property (nonatomic, strong) NSMutableArray *data;
@end

@implementation TMenuView
...
- (void)setupViews
{
    ...
    [_sendButton setTitle:YZMsg(@"发送") forState:UIControlStateNormal];
    ...
    [_menuCollectionView registerClass:[TMenuCell class] forCellWithReuseIdentifier:TMenuCell_ReuseId];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    if(indexPath.row % 2 == 0){
        TMenuCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:TMenuCell_ReuseId forIndexPath:indexPath];
