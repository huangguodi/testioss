...
//gift cell
#define TGiftMessageCell_ReuseId @"TGiftMessaageCell"
//call cell
#define TCallMessageCell_ReuseId @"TCallMessaageCell"
...
//menu view
#define TMenuView_Send_Color normalColors
...
#define TUIKitFace(name) [[[NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:@"YBFaceEmoji" ofType:@"bundle"]] resourcePath] stringByAppendingPathComponent:name]
#define TUIKitFacenew(name) [[[NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:@"YBFaceEmoji/emoji" ofType:@"bundle"]] resourcePath] stringByAppendingPathComponent:name]
...
#define TUIKitNotification_TIMCancelunread @"TUIKitNotification_TIMCancelunread"
// IM主动刷新
