...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *levelconstain;
...
@property (weak, nonatomic) IBOutlet UIImageView *vatypeImgV;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *videoaudioconst;

@property (weak, nonatomic) IBOutlet UIImageView *isauthImgV;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *authcoinst;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *authwidcoinst;
