...
-(instancetype)initWithDic:(NSDictionary *)dic
{
    ...
    if ([lagType isEqual:EN]) {
        _name_coin = [NSString stringWithFormat:@"%@",[dic valueForKey:@"name_coin_en"]];
        _name_votes = [NSString stringWithFormat:@"%@",[dic valueForKey:@"name_votes_en"]];
    }
        ...
        _sprout_key = [NSString stringWithFormat:@"%@",[dic valueForKey:@"sprout_key_ios"]];
        _sprout_appid_ios= [NSString stringWithFormat:@"%@",[dic valueForKey:@"sprout_appid_ios"]];
        ...
        _im_teenager_tips =minstr([dic valueForKey:@"im_teenager_tips"]);
        _leaderboard_switch =minstr([dic valueForKey:@"leaderboard_switch"]);
        _teenager_des =minstr([dic valueForKey:@"teenager_des"]);
