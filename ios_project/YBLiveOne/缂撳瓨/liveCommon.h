...
@property(nonatomic,  strong)NSString *sprout_appid_ios;
...
@property(nonatomic,  strong)NSString *im_teenager_tips;
@property(nonatomic,  strong)NSString *leaderboard_switch;//排行榜开关
@property(nonatomic,  strong)NSString *teenager_des;//青少年模式提示语
