...
//-(void)setPlayDoc:(NSDictionary *)playDoc
//{
//    self.playDoc = playDoc;
//}
...
//    self.fullScreenBtn.zf_centerY = self.currentTimeLabel.zf_centerY;
    ...
    min_w = 40;
    min_h = 26;
    self.focusBtn.frame = CGRectMake(min_x, min_y, min_w, min_h);
    self.focusBtn.zf_centerY = self.fullScreenBtn.zf_centerY;
...
- (UIButton *)fullScreenBtn {
    if (!_fullScreenBtn) {
        ...
        [_fullScreenBtn setImage:[UIImage imageNamed:@"personBack"] forState:UIControlStateNormal];
    }
...
- (UIButton *)focusBtn {
    if(!_focusBtn){
        ...
        _focusBtn.layer.cornerRadius = 13;
        ...
        [_focusBtn setBackgroundColor:normalColors];
    }
    return _focusBtn;
}
-(void)guanzhuzhubo{
