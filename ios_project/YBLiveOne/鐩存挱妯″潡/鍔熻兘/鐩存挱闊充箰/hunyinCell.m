...
-(void)setModel:(hunyinModel *)model{
    ...
    NSString *loadPath = [docDir stringByAppendingFormat:@"/%@*%@*%@_%@.mp3",_model.songid,_model.songname,_model.artistname,self.typeStr];
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection{
    ...
    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
    NSString *docDir = [paths objectAtIndex:0];
    musicPath = [docDir stringByAppendingFormat:@"/%@*%@*%@_%@.mp3",_model.songid,_model.songname,_model.artistname,self.typeStr];
