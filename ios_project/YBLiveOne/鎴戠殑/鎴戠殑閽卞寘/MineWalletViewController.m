...
- (void)viewDidLoad {
    ...
    NSArray *titleA = @[YZMsg(@"充值"),YZMsg(@"我的明细"),YZMsg(@"我的收益")];
    ...
    UIView *view = [[UIView alloc]initWithFrame:CGRectMake(30, headerImgV.bottom-30, _window_width-60, 50*titleA.count)];
