...
- (void)requetData{
    [YBToolClass postNetworkWithUrl:@"Video.getReport" andParameter:nil success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        if (code == 0) {
...
- (void)dojubao{
    ...
    [YBToolClass postNetworkWithUrl:@"Video.setReport" andParameter:parameterDic success:^(int code, id  _Nonnull info, NSString * _Nonnull msg) {
        if (code == 0) {
