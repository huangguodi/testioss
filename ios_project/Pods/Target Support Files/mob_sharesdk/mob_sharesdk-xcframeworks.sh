...
install_xcframework "${PODS_ROOT}/mob_sharesdk/ShareSDK/Support/PlatformConnector/WechatConnector.xcframework" "mob_sharesdk/ShareSDKPlatforms/WeChatFull" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
