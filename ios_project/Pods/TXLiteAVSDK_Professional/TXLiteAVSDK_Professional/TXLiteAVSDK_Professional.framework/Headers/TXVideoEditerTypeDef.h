...
/// 视频信息
LITEAV_EXPORT @interface TXVideoInfo : NSObject
/// 视频首帧图片
...
/// 短视频预览参数
LITEAV_EXPORT @interface TXPreviewParam : NSObject
/// 视频预览View
...
/// 字幕
LITEAV_EXPORT @interface TXSubtitle : NSObject
...
/// 贴纸
LITEAV_EXPORT @interface TXPaster : NSObject
/// 贴纸图片
...
/// 动图
LITEAV_EXPORT @interface TXAnimatedPaster : NSObject
/// 动图文件路径
...
/// 重复播放
LITEAV_EXPORT @interface TXRepeat : NSObject
/// 重复播放起始时间(s)
@property(nonatomic, assign) CGFloat startTime;
/// 重复播放结束时间(s)
@property(nonatomic, assign) CGFloat endTime;
...
/// 加速播放参数
LITEAV_EXPORT @interface TXSpeed : NSObject
/// 加速播放起始时间(s)
@property(nonatomic, assign) CGFloat startTime;
/// 加速播放结束时间(s)
@property(nonatomic, assign) CGFloat endTime;
...
/// 生成视频结果
LITEAV_EXPORT @interface TXGenerateResult : NSObject
/// 错误码
...
/// 短视频合成结果
LITEAV_EXPORT @interface TXJoinerResult : NSObject
/// 错误码
